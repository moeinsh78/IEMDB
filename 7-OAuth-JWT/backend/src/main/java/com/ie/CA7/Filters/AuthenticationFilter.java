...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if(req.getServletPath().contains("movies") || req.getServletPath().contains("login") || req.getServletPath().contains("signup") || req.getServletPath().contains("callback")) {
        ...
        try {
            ...
            if(iemdbSystem.getLoggedInUser() == null) {
                iemdbSystem.loginWithJwtToken(claimsJws.getBody().get("userEmail").toString());
            }
        }
